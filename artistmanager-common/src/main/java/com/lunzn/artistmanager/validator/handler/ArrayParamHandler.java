...
import com.lunzn.artistmanager.message.reqest.IMsgRequestData;
...
public class ArrayParamHandler implements Handler
{
        ...
        throws InnerException
    {
        ...
        for (Object object : list)
        {
            ...
            // 业务封装类，递归校验封装类对象
            if (IMsgRequestData.class.isAssignableFrom(itemClazz))
            {
                IMsgRequestData itemObj = (IMsgRequestData)JSON.parseObject(JSON.toJSONString(object), itemClazz);
