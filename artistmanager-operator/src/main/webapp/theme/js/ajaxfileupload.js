...
jQuery
		.extend({
			...
			createUploadForm : function(id, fileElementId, data)// 增加了data参数
			{
				// create form
			...
			ajaxFileUpload : function(s) {
				...
				var form = jQuery.createUploadForm(id, s.fileElementId, s.data);// 增加了data参数
					...
					if (xml || isTimeout == "timeout") {
						...
						try {
							...
							if (status != "error") {
								...
								// throughhttpData regardless of callback)
